...
// tab切换
$.fn.tabSwitch=function(o){
    o=$.extend({
        eventType:"hover",
        switchNav:".switchNav",//切换标签
        switchCont:".switchCont",//切换内容
        active:"active"
    },o||{});
    return this.each(function(){
        var _this=$(this);
        _this.find(o.switchNav).bind(o.eventType,function(){
            var _index=$(this).index();
            $(this).addClass(o.active).siblings(o.switchNav).removeClass(o.active);
            _this.find(o.switchCont).eq(_index).addClass(o.active).siblings(o.switchCont).removeClass(o.active);
        });
    });
};

$(function(){
    $(".cont_type").tabSwitch({eventType:"click"});
...
function FloatAd(selector) {
    ...
    var windowHeight = $("body").height();//浏览器高度
    var windowWidth = $("body").width();//浏览器宽度
